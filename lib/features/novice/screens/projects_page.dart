...
class NoviceProjectsPage extends StatefulWidget {
  const NoviceProjectsPage({super.key});

  @override
  State<NoviceProjectsPage> createState() => _NoviceProjectsPageState();
}

class _NoviceProjectsPageState extends State<NoviceProjectsPage> {
